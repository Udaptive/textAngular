...
var unsanitizedElements = makeMap("table,aq-input-ref,alternatives,annotation,equation,aq-parameterized-picker,aq-input-ref,aq-inline-activity,term");
...
function validCustomTag(tag, attrs, lkey, value){
  // catch the div placeholder for the iframe replacement
    ...
    if (tag === 'span'){
        if(lkey.startsWith('data-aq') || lkey === 'activityLink' || lkey === 'data-asset-id' || lkey === 'aq-tag-icon' || lkey === 'entry' || lkey === 'id' || lkey === 'comment' || lkey === 'table' || lkey === 'table-html' || lkey === 'term') {
          return true;
        }
    }
    return false;
